...
func placeBombOnMap():
	...
	## Vector2 pra INT pega a posicao do node pai q é o player e divide por 16 q é o tamanho do tileset e multiplica por 16 pra dar o valor que "encaixa" no quadradin
